...
To evaluate and anlyse the Likert scale data, different mathmatical formulas is applied. To analyse the data, the mean will be calculated as well as the standart deviation to see how the responses turned out. To test the validity of the test the Cronbach Alpha method will be applied\ref{DAEBook}
