...
\subsection{Findings}
To find out how the system scores on the SUS scale some calculation must be made. The scoring system of the SUS ranges from 0-100 with 2.5 increments. The calculation is shown below:
