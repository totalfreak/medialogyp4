...
In order to get feedback for the test to validify the final problem statement, it is neccessary to conduct the test with the target group mentioned in section \ref{sec:targetgroup}. In order to get test participants that fit the needs of the target group and final problem statement, the quota sampling technique is used, as it bases the participants on preselected features or traits.\\
