\chapter{Analysis}
\subsection{What is music? Audiation:} \todo{Cut from this into the introduction.}
\begin{quote}
...
\subsection*{Emotions}
Write something about emotions' relations to motivation, keep it short.
...
\end{comment}
\subsection*{Sub conclusion}
In conclusion, whether motivation is extrinsic or intrinsic, it is a core part of performing any action. Learning specifically is usually an intrinsically motivated action and hence is something
