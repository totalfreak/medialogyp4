...
\section{Interactivity of music learning}\todo{Also, explain why interaction is good.}
	...
	According to Deirdre Russel-Bowie there are 5 basic musical elements that should be learned to have a good understanding of music:\todo{Maybe start with this part, to introduce section}
	\begin{itemize}
		\item Duration
		\item Pitch
		\item Tone color
