...
\section{Design Requirements}
	\subsection*{Functional Requirements}
		\begin{itemize}
			\item[-] Min 2 Children.\\
			\item[-] Max 6 Children.\\
			\item[-] Must facilitate collaboration within at least one of the three musical competence areas.\\
			\item[-] Must be designed for Children aged 8-12.\\
			\begin{itemize}
				\item[$\cdot$] It should strive to not induce  negative emotions.\\
				\item[$\cdot$] It should strive to induce positive emotions.\\
			\end{itemize}
