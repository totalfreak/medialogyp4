...
\subsection{Choice of Direction} % subconclusion of problem area and reasoning for chosing to work focused on collaboration.
...
\subsection{Collaborative learning Methods} % Sofie

\subsubsection{Cooperative learning} % Jens 

\subsubsection{competitive learning} %Jens 
