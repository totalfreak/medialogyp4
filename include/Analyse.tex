...
sed where the students are not getting involved in the lecture. This form of teaching is usually seen on universities where the professors gives a lecture, and does not provide assignments or feedback to the students. This means that the learning method belongs in the bottom bracket of the retention of learning triangle as seen above. This way of teaching is usually the least efficient when the goal is to teach or alter information.\\
	...
	However, it is not an entirely unexplored area, and studies have shown that collaboration can stimulate students critical and creative thinking, and rich musical experiences can surface when ideas from larger groups are combined\cite{collaborativeLearningTeachers}. 
	The article also introduces three principles of collaboration, that are based on interviews with three teachers:\\
	\begin{enumerate}
	...
	Another set of principles are introduces in the article \textit{Collaborative learning in music education: A review of the litterature}\cite{collaborativeLearningReview}\\
	\todo{Elaborate}
