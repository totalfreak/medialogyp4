...
According to Deirdre Russel-Bowie there are 5 basic musical elements that should be learned to have a good understanding of music\cite{primaryArts}:\todo{Use this for some cool shit}
...
\section{Problem Area}
	...
	When the children get older, they will be introduced to digital tools and syntesizers to be used in the classroom. These tools might include iPad or Garageband. On these devices, they are asked to compose a musical piece using the aforementioned knowledge.\\
...
\section{Interactivity of music learning}	
	...
	When the student participants where asked about their musical knowledge gained from playing interactive music video games, something something positive stuff.\todo{Finish writing this.}
	\begin{comment}
