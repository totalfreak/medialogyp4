...
According to Deirdre Russel-Bowie there are 5 basic musical elements that should be learned to have a good understanding of music\cite{interactiveMusicVideoGames}:\todo{Use this for some cool shit if relevant}
...
\section{Interactivity of music learning}	
	...
	\end{quote}
	The participant felt that they had gained music knowledge, and broadened their musical identity. \todo{Write this betterer}
	\subsection*{Sub conclusion}
		In conclusion, according to Lily Gower and Janet McDowall's study\cite{interactiveMusicVideoGames}, interactive music video games can most likely teach children about pitch and rhythm\todo{Maybe write about this in section before, to conclude upon} (See all five elements in \autoref{list:basicMusic}), and might broaden their musical knowledge.
