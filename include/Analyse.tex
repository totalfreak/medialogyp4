...
\section{Problem Area}
	...
	\\
	According to the study plan, the children is required to learn three base line these within the elementary school music course\todo{This doesn't make sense}. \todo{Re-structured}
	...
	Musical understanding is, first of, to be able to express music in other forms than sound\todo{Rewrite}\todo{Re-Structured}. For an example, they should be able to express themselves verbally \todo{Not a real word}\todo{corrected spelling error} about music and be able to draw music. The children should have knowledge about instruments, and the ability to differ the different instruments from their appearance as well as their sound. The children should be able recognize specific elements in a musical piece and identify them. Finally, they should have the knowledge of musical history, in relation to different music genre as well as music from different time periods.
	\\
...
\section{Interactivity of music learning}	
	...
	\subsection*{Sub conclusion}
		Have a sub conclusion for section, make it good and informative.\\
		Cite for constructivism\cite{constructivism}
