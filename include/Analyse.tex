...
When working in groups different aspects affect the productivity and level of performance{(God klassekultur Ref)}. in this section some of these aspects will be discussed. These include: roles within a group, inclusion and exclusion from a group, Feedback as an important group tool, and different group constellations - collaborative- and peer Learning.
