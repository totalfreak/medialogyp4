...
\section{Interactivity of music learning}\todo{Write this betterer, more focus on specifics on test.}\todo{Also, explain why interaction is good.}
	...
	The different games mentioned in the study, was Guitar hero (See \autoref{sec:guitarHero}), SingStar and Wii Music. What these games have in common is that they all use interactivity as a means to playing music, be it with a guitar shaped controller, a microphone or the Wii remote held like an instrument. These games try to emulate what it would \textit{feel like} to play a guitar or sing. The study into the games and their educational qualities\cite{interactiveMusicVideoGames}, interviewed two music teachers of different musical affinities, and 9 music students (5 boys and 4 girls) from different socio-economic situations. \todo{Talk about the teachers' quotes, and students' quotes, take out snippets, and use for explaining interactivity in music teaching.}
