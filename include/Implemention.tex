...
\section{The mat}%Daniel
	...
	\begin{figure}[H]
		...
		\caption{The final structure of the mat's fields, with foil on the inside of the top and bottom, and a thin foam layer in the middle, to reinflate the field after it's been activated.\todo{Update caption}}
	...
	\begin{figure}[H]
		...
		\label{fig:finalMat}
	\end{figure}
 	To provide some usability to the mat, a LED strip was added spanning the top part of the beats, so as to signify what beat was currently active.
